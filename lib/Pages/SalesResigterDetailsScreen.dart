                      ...
                      child: Column(
                        children: widget.mainList.map((client) {
                          return Container(
                            ...
                            child: Row(
                              children: [
                                SizedBox(width: 200, child: dataText(client['clientname'],color: Colors.indigo,leftAlign: 1)),
                                SizedBox(width: 120, child: dataText(client['vrdate'],color: Colors.orange,leftAlign: 1)),
                                ...
                                SizedBox(width: 120, child: dataText(client['vrno'],color: Colors.orange)),
                                SizedBox(width: 120, child: dataText(client['metal'],color: Colors.orange)),
                                SizedBox(width: 150, child: dataText(client['sku'],color: Colors.indigo)),
                                SizedBox(width: 120, child: dataText(client['family'],color: Colors.indigo)),
                                SizedBox(width: 120, child: dataText(client['category'],color: Colors.indigo)),
                                SizedBox(width: 120, child: dataText(client['grosswt'],color: Colors.indigo)),
                                SizedBox(width: 120, child: dataText(client['netwt'],color: Colors.indigo)),
                                SizedBox(width: 120, child: dataText(client['saleprice'],color: Colors.indigo)),
                                SizedBox(width: 120, child: dataText(client['costprice'],color: Colors.indigo)),
                                SizedBox(width: 120, child: dataText(client['diamwt'],color: Colors.indigo)),
                                SizedBox(width: 120, child: dataText(client['cswt'],color: Colors.indigo)),
                              ],
                            ),
                          );
                        }).toList(),
